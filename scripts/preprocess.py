...
DOTA_LABEL_DIR = "../dota_labels"
DOTA_IMAGE_DIR = "../images"
DOTA_FORMATTED_LABEL_DIR = "../labels"
...
def main():
    ...
    move_files_to_folder(validation_images, '../images/validation/')
    move_files_to_folder(test_images, '../images/test/')
    move_files_to_folder(train_labels, '../labels/train/')
    move_files_to_folder(validation_labels, '../labels/validation/')
