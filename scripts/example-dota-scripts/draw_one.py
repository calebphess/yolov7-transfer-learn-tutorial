...
def main():
    label_file = "../yolo_formatted_labels/" + random.choice(os.listdir("../yolo_formatted_labels"))
    print(label_file)
    image_file = label_file.replace("yolo_formatted_labels", "images").replace(".txt", ".png")
